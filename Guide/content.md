...
- Shutter Speed (SS)<a name="shutter-speed"></a>
...
- Flash Power (FP)<a name="flash-power"></a>
  - Higher (1/1 or 10.0)
    - Brighter (↑ SJ EV)
  - Lower (1/512 or 0.1)
    - Darker (↓ SJ EV)
...
## Compensate Side Effects<a name="compensate-side-effects"></a>

1. Shutter Speed ↑, Do Either:<a name="increase-shutter-speed"></a>
...
2. Shutter Speed ↓, Do Either:<a name="decrease-shutter-speed"></a>
...
3. Aperture Value ↑, Do Either:<a name="increase-aperture-value"></a>
...
4. Aperture Value ↓, Do Either:<a name="decrease-aperture-value"></a>
...
5. ISO ↑, Do Either:<a name="increase-iso"></a>
...
6. ISO ↓, Do Either:<a name="decrease-iso"></a>
...
7. Flash Power ↑, Do Either:<a name="increase-flash-power"></a>
...
8. Flash Power ↓, Do Either:<a name="decrease-flash-power"></a>
...
## Normal Photography<a name="normal-photography"></a>
...
### Normal Everyday Scene or Stills (e.g. Family, Friends, Portraits, etc.)<a name="normal-everyday-scene-or-stills-eg-family-friends-portraits-etc"></a>
...
### Fast Motion (e.g. Sports, Wildlife, Jumping, etc.)<a name="fast-motion-eg-sports-wildlife-jumping-etc"></a>
...
### Fast Moving Water Feature (e.g. Waterfall, River, etc.)<a name="fast-moving-water-feature-eg-waterfall-river-etc"></a>
...
### Macro (e.g. Insects, Flowers, etc.)<a name="macro-eg-insects-flowers-etc"></a>
...
### Multiple Exposures of Motion in a Single Shot (e.g. Ballet, etc.)<a name="multiple-exposures-of-motion-in-a-single-shot-eg-ballet-etc"></a>
...
#### Decrease Motion Blur<a name="decrease-motion-blur"></a>
...
#### Increase Motion Blur<a name="increase-motion-blur"></a>
...
### Background/Foreground Blur<a name="backgroundforeground-blur"></a>

#### Increase Background/Foreground Blur<a name="increase-backgroundforeground-blur"></a>
...
#### Decrease Background/Foreground Blur<a name="decrease-backgroundforeground-blur"></a>
...
### Background Exposure<a name="background-exposure"></a>

#### Decrease Background Exposure<a name="decrease-background-exposure"></a>
...
#### Increase Background Exposure<a name="increase-background-exposure"></a>
...
#### Sharper Shadows<a name="sharper-shadows"></a>
...
#### Make Background Blue<a name="make-background-blue"></a>
...
##### Rosco/Lee/Godox CTO Gel Codes<a name="rosco-lee-godox-cto-gel-codes"></a>
...
#### Make Background Orange<a name="make-background-orange"></a>
...
##### Rosco/Lee/Godox CTB Gel Codes<a name="rosco-lee-godox-ctb-gel-codes"></a>
...
### Other Effects<a name="other-effects"></a>

#### Add Bloom to Subject<a name="add-bloom-to-subject"></a>
